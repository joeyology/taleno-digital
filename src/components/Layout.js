    ...
    render() {
        ...
        return (
            <React.Fragment>
                <Helmet>
                    <title>
                        {_.get(this.props, 'page.frontmatter.seo.title', null) ? (_.get(this.props, 'page.frontmatter.seo.title', null)) : _.get(this.props, 'page.frontmatter.title', null) + ' | ' + _.get(this.props, 'data.config.title', null)}
                    </title>
                    <meta charSet="utf-8"/>
                    ...
                    {_.map(_.get(this.props, 'page.frontmatter.seo.extra', null),
                    (meta, meta_idx) => {
